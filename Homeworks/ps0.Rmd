...
author: "Jack Dove"
date: "due by 5 PM on Friday, August 28"
output:
...
> RESPONSE: The dataset has 1846 rows and 3 columns; those 3 variables are the dataset of origin, x-values, and y-values. 
...
> RESPONSE: The negative but low in magnitude correlation coefficient suggests a minimal relationship between x and y in the dino dataset. 
...
> RESPONSE: It's a drawing of a dinosaur using x/y coordinates. 
...
> RESPONSE: No; the density of the points varies, with large clusters coming at some corners of the star. 
